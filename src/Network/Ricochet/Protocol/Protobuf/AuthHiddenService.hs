{-|
  ...
  Description: Lenses for AuthHiddenService.proto messages

"Network.Ricochet.Protocol.Protobuf.AuthHiddenService" mostly re-exports lenses
that are generated by hprotoc.  One Maybe layer is removed from the record
members of 'AP.Packet'.
-}
