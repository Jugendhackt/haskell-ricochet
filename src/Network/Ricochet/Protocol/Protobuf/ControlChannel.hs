...
"Network.Ricochet.Protocol.Protobuf.ControlChannel" mostly re-exports lenses
that are generated by hprotoc.  Name conflicts are resolved by defining type
classes, and one Maybe layer is removed from the record members of 'CP.Packet'.
-}
