...
let
  ...
  f = { cabal-install, mkDerivation, attoparsec, base, base32string
      , base64-bytestring, bytestring , containers, hprotoc, HsOpenSSL, lens
      , mtl, network , network-anonymous-tor, socks, stdenv, transformers
      }:
      mkDerivation {
        ...
        libraryHaskellDepends = [ cabal-install
          attoparsec base base32string base64-bytestring bytestring containers
          hprotoc HsOpenSSL lens mtl network network-anonymous-tor socks
          transformers
        ];
